...
class BoundaryConditionTest : public testing::Test
{
    protected: 
        ...
        std::function<double(double, double, double)> u_coeff{[](double x, double y, double t){return 1.0;}};
        std::function<double(double, double, double)> du_coeff{[](double x, double y, double t){return 2.0;}};
    ...
    NeumannBC(f), 
    RobinBC(u_coeff, du_coeff, [](double x, double y, double t){ return x * std::exp(t - y); }) 
    {};
};
